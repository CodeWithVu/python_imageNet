...
def create_generators(train_df, valid_df, test_df, img_size=(200,200), batch_size=30):
    trgen = ImageDataGenerator(preprocessing_function=preprocess_input, horizontal_flip=True, rotation_range=20, width_shift_range=.2, height_shift_range=.2, zoom_range=.2)
    t_and_v_gen = ImageDataGenerator(preprocessing_function=preprocess_input)
